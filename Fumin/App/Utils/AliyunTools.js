...
//   // 文件链接地址
//   // static FILE_URL = `https://alsome.oss-cn-beijing.aliyuncs.com/${OBJECT_KEY}/`;
...
//       'LTAI4Fk144PTgHTwPzV1a1U4',
//       'w1e9wUbOIXOtEgzYx3cUBn7Qdoiqgj',
//       END_POINT,
//       configuration,
//     );
//   }
...
//     const FILE_URL = `https://alsome.oss-cn-beijing.aliyuncs.com/${tempObject}/`;
